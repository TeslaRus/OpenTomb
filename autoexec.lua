...
function c1() loadMap("data/tr1/data/CUT1.PHD"); end;
function c2() loadMap("data/tr1/data/CUT2.PHD"); end;
function c3() loadMap("data/tr1/data/CUT3.PHD"); end;
function c4() loadMap("data/tr1/data/CUT4.PHD"); end;
